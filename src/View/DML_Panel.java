...
public class DML_Panel extends JPanel{
   ...
   private void panelInit(JFrame frame) {
      ...
      area_t.setBounds(140, 170, 70, 30);
      ...
      status_t.setBounds(210, 170, 70, 30);
      ...
      route_t.setBounds(0, 230, 400, 30);
      ...
      travel_t.setBounds(0, 290, 400, 30);
      ...
      contact_t.setBounds(0, 350, 400, 30);
